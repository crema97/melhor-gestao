-- CORRIGIR FOREIGN KEY PARA REFERENCIAR USER_ID
...
-- 2. Adicionar o foreign key correto (referenciando user_id)
ALTER TABLE usuario_categorias_ativas 
...
/*
-- Pegue um user_id de um usuário
SELECT user_id, nome, email FROM usuarios LIMIT 1;
