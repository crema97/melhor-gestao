...
export default function MinhaContaSalaoBeleza() {
  ...
  async function checkUserAndLoadData() {
    try {
      ...
      // Verificar se o usuário tem acesso ao dashboard de salão de beleza
      ...
      // Verificar se é um usuário de salão de beleza (tipo_negocio_id = 5)
      if (usuarioData.tipo_negocio_id !== '5') {
      ...
      <div style={{
        ...
        <div>
          <h1 style={{
            ...
            Minha Conta - {usuario?.nome_negocio || 'Salão de Beleza'}
          </h1>
          <p style={{
            color: '#9ca3af',
            margin: 0,
        ...
        <div style={{ display: 'flex', gap: '12px' }}>
          <button
            onClick={() => router.push('/dashboard/salao-beleza')}
            style={{
              padding: '10px 20px',
